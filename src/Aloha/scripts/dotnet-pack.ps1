...
New-Variable -Name "project" -Value "Aloha"
...
dotnet pack Aloha.csproj -c release /p:PackageVersion="$version" --no-restore -o .

Write-Host Uploading Aloha package to Nuget
