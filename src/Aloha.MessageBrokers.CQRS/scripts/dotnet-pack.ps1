...
New-Variable -Name "project" -Value "Aloha.MessageBrokers.CQRS"
...
dotnet pack Aloha.MessageBrokers.CQRS.csproj -c release /p:PackageVersion="$version" --no-restore -o .

Write-Host Uploading Aloha.MessageBrokers.CQRS package to Nuget
