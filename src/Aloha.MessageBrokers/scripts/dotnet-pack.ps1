...
New-Variable -Name "project" -Value "Aloha.MessageBrokers"
...
dotnet pack Aloha.MessageBrokers.csproj -c release /p:PackageVersion="$version" --no-restore -o .

Write-Host Uploading Aloha.MessageBrokers package to Nuget
