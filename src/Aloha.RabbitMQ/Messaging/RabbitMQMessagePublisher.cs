...
namespace Aloha.MessageBrokers.RabbitMQ.Messaging
{
    public class RabbitMQMessagePublisher : IMessagePublisher
    {
        ...
        /// Publish a message.
        /// </summary>
        /// <param name="correlationContextId">Correlation context id of message.</param>
        ...
        public Task PublishMessageAsync(string correlationId, object message, string routingKey)
        {
            return Task.Run(() =>
                Policy
                    .Handle<Exception>()
                    ...
                    .Execute(() =>
                    {
                        ...
                        using (var connection = factory.CreateConnection())
                        {
                            using (var model = connection.CreateModel())
                            {
                                ...
                                properties.Headers = new Dictionary<string, object> { { "CorrelationId", correlationId } };
